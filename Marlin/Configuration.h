...
#define STRING_CONFIG_H_AUTHOR "Jarvis B. J. Bajuelo (ELPIKA)" // Who made the changes.
 ...
 */
#define BAUDRATE 115200  // "PIKA" increase serial performace  // 115K for SKR MINI

#define BAUD_RATE_GCODE     // Enable G-code M575 to set the baud rate  // "PIKA" Enables change the baudrate
...
#define EXTRUDE_MINTEMP 180  // "PIKA" Customizable by menu
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 430 }  // Ender Configs "PIKA" MY STEPS
...
#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2  // "PIKA" allows higher limits
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 1000, 1000, 40, 200 } // ...or, set your own edit limits  // "PIKA" allows higher limits
#endif
...
#define CLASSIC_JERK  // Ender Configs
  ...
  #define LIMITED_JERK_EDITING        // Limit edit via M205 or LCD to DEFAULT_aJERK * 2  // Ender Configs
    ...
    #define MAX_JERK_EDIT_VALUES { 20, 20, 0.6, 20 } // ...or, set your own edit limits  // MRiscoC allows higher limits
  #endif
#endif
 ...
 */
#define S_CURVE_ACCELERATION  // "PIKA" Enabled
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -47, -7, 0}  // "PIKA" BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
 ...
 */
#define MULTIPLE_PROBING 2  // "PIKA" Enabled
#define EXTRA_PROBING    1  // "PIKA" Enabled
...
#endif
#define PROBING_FANS_OFF          // Turn fans off when probing  // "PIKA" Turn fans off for avoid vibrations and interference
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
#define DELAY_BEFORE_PROBING 200  // (ms) To prevent vibrations from triggering piezo sensors  // "PIKA" Wait for stability
...
#define HOME_AFTER_DEACTIVATE   // Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety.  // "PIKA" Enabled for safety
...
#define FILAMENT_RUNOUT_SENSOR  // "PIKA" Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25  // "PIKA" Customizable by menu
...
//#define AUTO_BED_LEVELING_BILINEAR  // "PIKA" BLTouch auto level  // Disabled for UBL
#define AUTO_BED_LEVELING_UBL  // "PIKA" UBL
 ...
 */
#define PREHEAT_BEFORE_LEVELING  // "PIKA" Heatting to compensate thermal expansions
#if ENABLED(PREHEAT_BEFORE_LEVELING)
  #define LEVELING_NOZZLE_TEMP   0   // (°C) Only applies to E0 at this time  // "PIKA" No necessary for BLTouch
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5      // Don't use more than 15 points per axis, implementation limited.  // "PIKA" Customizable by menu
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
...
#define EEPROM_BOOT_SILENT    // Keep M503 quiet and only give errors during first load
  ...
  #define EEPROM_INIT_NOW   // Init EEPROM on first boot after a new build.  // "PIKA" Reset EEPROM on first boot
#endif
 ...
 */
#define NOZZLE_PARK_FEATURE  // "PIKA" Enabled

#if ENABLED(NOZZLE_PARK_FEATURE)
  // Specify a park position as { X, Y, Z_raise }
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 } // "PIKA" Change X_MIN_POS for X_BED_SIZE if mesh leveling or tramming don't work properly
  #define NOZZLE_PARK_MOVE          0   // Park motion: 0 = XY Move, 1 = X Only, 2 = Y Only, 3 = X before Y, 4 = Y before X
  #define NOZZLE_PARK_Z_RAISE_MIN   0   // (mm) Always raise Z by at least this distance  // "PIKA" uses Park Z Raise from 0 to avoid backlash issues
 ...
 */
#define PRINTCOUNTER  // "PIKA" Enable Print Statistics
