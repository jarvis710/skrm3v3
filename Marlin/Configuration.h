...
#define STRING_CONFIG_H_AUTHOR " Jarvis B. J. B. - EL PIKA - " // Who made the changes.
...
#define BAUDRATE_3  115200    //250000   // :[2400, 9600, 19200, 38400, 57600, 115200, 250000, 500000, 1000000] Enable to override BAUDRATE

// Enable the Bluetooth serial interface on AT90USB devices
//#define BLUETOOTH

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME " PIKA -SKRME3V3-BLTUBL-LA "
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 430.5 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -7.5, -2.20 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
//#define PROBE_ENABLE_DISABLE
  ...
  #define PROBE_ENABLE_PIN PC14   // Override the default pin here
#endif
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS X_BED_SIZE + 10  // MRiscoC Stock physical limit
...
#define FILAMENT_RUNOUT_SENSOR  // MRiscoC Enabled runout sensor support
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 35  // MRiscoC Customizable by menu
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_BED_SIZE + 10), (Y_MIN_POS+10), 20 }
